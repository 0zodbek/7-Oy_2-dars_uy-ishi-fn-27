...
const HomePage = () => {
  ...
  return (
    <div className={theme === 'light' ? 'bg-blue-50 text-gray-900 ' : 'bg-gray-900 text-white '}>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between w-[1388px] h-[777px] mx-auto m-6 bg-[url(C:\Users\Noutbukcom\Desktop\2-dars-uy-ishi-fn27\src\assets\bg.svg)] bg-cover bg-center rounded-[50px]">
